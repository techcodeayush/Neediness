...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" > <b style="color:  ">Neediness</b></p>
             <p class="user"></p>
...
var yplace=[<?php echo json_encode($Lucknow,JSON_HEX_TAG);?>,<?php echo json_encode($Mirzapur,JSON_HEX_TAG);?>,<?php echo json_encode($Delhi,JSON_HEX_TAG);?>];
